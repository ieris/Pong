package screens
{
	...
	public class Welcome extends Sprite
	{
		...
		public function onOnePlayerClick(event:Event):void
		{
			...
			if ((buttonClicked as Button == onePlayerButton)
				{
					...
					this.removeEventListener(Event.EVENT_FRAME, onOnePLayerClick);
				}
				else if ((buttonClicked as Button == twoPlayerButton)
					{
					...
					else if ((buttonClicked as Button == leaderboardButton)
						{
							...
							this.removeEventListener(Event.EVENT_FRAME, onLeaderboardClick);
						}
						else if ((buttonClicked as Button == optionsButton)
							{
								...
								this.removeEventListener(Event.EVENT_FRAME, onOptionsClick);
							}
							}
